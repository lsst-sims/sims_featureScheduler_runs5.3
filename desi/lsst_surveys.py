...
def gen_desi_surveys(
    ...
    for bandname in band1s:
        ...
        # mask after N observations
        bfs.append(
            (
                bf.MaskAfterNObsBasisFunction(
                    n_max=n_obs_max, nside=nside, bandname=bandname
                ),
                0.0,
            )
        )
        ...
        surveys.append(
            BlobSurvey(
                ...
                survey_name=survey_name,
                science_program=science_program,
                observation_reason=f"desi_blob_{bandname}_{pair_time:.1f}",
                ignore_obs=ignore_obs,
                nexp=nexp,
                detailers=detailer_list,
                area_required=area_required,
