...
def get_scheduler(for_simulation=False) -> tuple[int, CoreScheduler]:
    ...
    template_surveys_reg = lsst_surveys.gen_template_surveys(
        template_fp,
        nside=nside,
        band1s=["g", "g", "r", "r", "i", "r", "z", "y"],
        band2s=["g", "r", "r", "i", "z", "z", "y", "y"],
    ...
    # Now just the u-band for two years
    template_surveys_u = lsst_surveys.gen_template_surveys(
        template_fp,
        nside=nside,
        band1s=["u"],
        band2s=["u"],
    ...
    template_surveys = template_surveys_u + template_surveys_reg
