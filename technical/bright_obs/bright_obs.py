...
from rubin_scheduler.scheduler.model_observatory import BrightObservatoryModel
...
def make_observatory(
    ...
    observatory = BrightObservatoryModel(
        nside=nside,
...
) -> tuple[BrightObservatoryModel, CoreScheduler, ObservationArray]:
    """Run survey"""
    n_visit_limit = None
